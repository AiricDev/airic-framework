...
import { CaseService } from "../../src/application/case-service.js";
import { JsonCaseRepository } from "../../src/infrastructure/json-case-repository.js";
import { createAppHttpHandler, sendJson, type AppRoute } from "../../src/http/application-handler.js";
import { resolveActor } from "../../src/http/actor.js";
import { createAppRoutes } from "../../src/http/routes.js";
...
describe("application HTTP handler", () => {
  it("serves health and the case list through the business API", async () => {
    const health = await (await fetch(`${base}/api/app/health`)).json();
